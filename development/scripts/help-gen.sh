...
source "$USER_HOME/devenv/development/scripts/parse-py.sh"
source "$USER_HOME/devenv/development/scripts/parse-js.sh"
source "$USER_HOME/devenv/development/scripts/parse-go.sh"
source "$USER_HOME/devenv/development/scripts/parse-rust.sh"
source "$USER_HOME/devenv/development/scripts/parse-java.sh"
source "$USER_HOME/devenv/development/scripts/parse-ruby.sh"
source "$USER_HOME/devenv/development/scripts/parse-php.sh"
source "$USER_HOME/devenv/development/scripts/parse-c-cpp.sh"
source "$USER_HOME/devenv/development/scripts/parse-dotnet.sh"
